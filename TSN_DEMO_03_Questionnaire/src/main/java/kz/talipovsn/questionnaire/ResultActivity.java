...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.append(String.format("%s %s \n", getString(R.string.Возраст), getIntent().getStringExtra("age")));
        editText.append(String.format("%s %s \n", getString(R.string.Пол), getIntent().getStringExtra("gender")));
        editText.append(String.format("%s %s \n", getString(R.string.Образование), getIntent().getStringExtra("edu")));
